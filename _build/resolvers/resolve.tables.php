...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('cto_core_path', null, $modx->getOption('core_path') . 'components/cto/') . 'model/';
            $modx->addPackage('cto', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/cto/model/schema/cto.mysql.schema.xml';
